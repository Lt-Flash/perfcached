...
**0.4.0** line is at release candidate 20 (2026-09-21), which is what
...
CHANGELOG says so against each.  Start from rc20, a capability step: **Redis pub/sub on every door and
