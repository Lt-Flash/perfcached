...
**0.4.0** line is at release candidate 22 (2026-09-21), which is what
...
CHANGELOG says so against each.  Start from rc22, a capability step: **Redis pub/sub on every door and
