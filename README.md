...
**0.4.0** line is at release candidate 31 (2026-09-25), which is what
...
CHANGELOG says so against each.  Start from rc31, a capability step: **Redis pub/sub on every door and
