...
**0.4.0** line is at release candidate 30 (2026-09-25), which is what
...
CHANGELOG says so against each.  Start from rc30, a capability step: **Redis pub/sub on every door and
