...
**0.4.0** line is at release candidate 23 (2026-09-21), which is what
...
CHANGELOG says so against each.  Start from rc23, a capability step: **Redis pub/sub on every door and
...
peer before the owner's push and delete nothing.  Off by default,
