...
**0.4.0** line is at release candidate 26 (2026-09-22), which is what
...
CHANGELOG says so against each.  Start from rc26, a capability step: **Redis pub/sub on every door and
...
everything, so the gain is bounded - about 3x at most - and a hot key
