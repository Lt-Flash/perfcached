...
**0.4.0** line is at release candidate 18 (2026-09-21), which is what
...
CHANGELOG says so against each.  Start from rc18, a capability step: **Redis pub/sub on every door and
