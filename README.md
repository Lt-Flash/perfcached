...
**0.4.0** line is at release candidate 29 (2026-09-24), which is what
...
CHANGELOG says so against each.  Start from rc29, a capability step: **Redis pub/sub on every door and
...
sweep.  A snapshot is what makes a single node independently
