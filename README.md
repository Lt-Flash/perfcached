...
**0.4.0** line is at release candidate 17 (2026-09-20), which is what
...
CHANGELOG says so against each.  Start from rc17, a capability step: **Redis pub/sub on every door and
