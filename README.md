...
**0.4.0** line is at release candidate 41 (2026-09-26), which is what
...
only on a tag - and 11, 12, 35 and 40 are superseded; the CHANGELOG says
so against each.  Start from rc41, a capability step: **Redis pub/sub on every door and
