...
**0.4.0** line is at release candidate 24 (2026-09-22), which is what
...
CHANGELOG says so against each.  Start from rc24, a capability step: **Redis pub/sub on every door and
