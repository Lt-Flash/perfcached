...
**0.4.0** line is at release candidate 38 (2026-09-26), which is what
the test fleet runs.  Candidates 10, 13, 14, 30-34, 36 and 37 of that
line are RED - their pipelines failed `tailtest`, `growtest`, `pintest`,
`sweepclocktest` (30, 31), `loadtest` (32), `keysretiretest` and
`outagetest` (33), `applythreadstest` (34), `healtest` (36) and
...
rc38, a capability step: **Redis pub/sub on every door and
