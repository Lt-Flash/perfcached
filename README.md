...
the staging fleet; the **0.4.0** line is at release candidate 5
(2026-09-18), a capability step: **Redis pub/sub on every door and
...
It carries the 0.3.8 candidates' four
