...
**0.4.0** line is at release candidate 43 (2026-09-26), which is what
...
each a suite that runs only on a tag - and 11, 12, 35, 40 and 41 are superseded; the CHANGELOG
says so against each.  Start from rc43, a capability step: **Redis pub/sub on every door and
