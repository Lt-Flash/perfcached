...
**0.4.0** line is at release candidate 25 (2026-09-22), which is what
...
CHANGELOG says so against each.  Start from rc25, a capability step: **Redis pub/sub on every door and
