...
#   2. a pipelined burst of 20,000 x 4 KB on 4 connections overflows the rings - records are
#      DROPPED (the load is real: if nothing drops, this proves nothing);
...
# Usage: test/healtest.sh [./perfcached]
set -u
BIN=${1:-./perfcached}
