...
')
[ "$S208" = ok ] && ok "S208/S227: the header aligns on centre, both marks share --markpx (60-72 px since S227), the controls are one right-aligned group, the option no longer says (this node)" \
	|| bad "S208: $S208"
