...
/* the same figure, for callers that render their own document rather
 * than the Prometheus exposition; 0 if the start was never stamped, so
 * "not up yet" stays distinguishable from "up for no time at all" */
