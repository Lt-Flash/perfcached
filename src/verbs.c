...
static int rh_expire(struct resp_ctx *c)
{
	...
	k.s = c->argv[1];
	k.len = (int)c->argl[1];
	resp_int(c->out, op_expire(c->ht, &k, ttl) == PC_OP_OK ? 1 : 0);
	return 0;
}
...
static const struct resp_cmd resp_cmds[] = {
	...
	{ "GET", RESP_DATA, rh_get }, { "SET", RESP_DATA, rh_set },
	{ "SETEX", RESP_DATA, rh_set }, { "PSETEX", RESP_DATA, rh_set },
	{ "DEL", RESP_DATA, rh_del }, { "UNLINK", RESP_DATA, rh_del },
	{ "EXISTS", RESP_DATA, rh_exists }, { "TYPE", RESP_DATA, rh_type },
	{ "EXPIRE", RESP_DATA, rh_expire }, { "PEXPIRE", RESP_DATA, rh_expire },
	{ "EXPIREAT", RESP_DATA, rh_expire }, { "PEXPIREAT", RESP_DATA, rh_expire },
	{ "TTL", RESP_DATA, rh_ttl }, { "PTTL", RESP_DATA, rh_ttl },
	{ "INCR", RESP_DATA, rh_incr }, { "DECR", RESP_DATA, rh_incr },
	{ "INCRBY", RESP_DATA, rh_incr }, { "DECRBY", RESP_DATA, rh_incr },
	...
	{ "JSON.SET", RESP_DATA, rh_json }, { "JSON.GET", RESP_DATA, rh_json },
	{ "JSON.DEL", RESP_DATA, rh_json },
	{ "JSON.NUMINCRBY", RESP_DATA, rh_json },
	{ "JSON.ARRAPPEND", RESP_DATA, rh_json },
