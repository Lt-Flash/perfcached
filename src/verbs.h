 ...
 * every caller; a stale pointer finds nobody.  NULL from a door that
 * has no privilege concept (binary, RESP) - those cannot enable and
 * cannot call a privileged verb. */
