...
/* S129: the privilege secret.  _ok is constant time and fail-closed
 * (no secret configured = never true); _configured answers the startup
 * warning and the "why did enable fail" message. */
