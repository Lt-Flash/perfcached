...
const char pc_status_page[] =
	...
	"var c=s.cluster||{},m=s.memory||{},r=s.resp||{},pr=s.process||{},\n"
	...
	"card(\"replication\",[[\"records out\",nf(c.repl_out)],[\"migrated in\",nf(c.migrated_in)],\n"
	...
	"card(\"resp door\",[[\"clients\",nf(r.conns)],\n"
