...
const char pc_status_page[] =
	 ...
	 * where their own box put them.  The controls are ONE group that
	 * right-aligns while it fits and drops as a whole when it does not;
	 * the header itself never wraps item by item. */
	...
	".ctl{display:flex;flex-wrap:wrap;align-items:center;gap:10px 16px;margin-left:auto}\n"
