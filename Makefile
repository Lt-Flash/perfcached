...
check-fast: selftest selftest_broken memprobe noisetest wipetest perfcached pubsubcli udppushcli \
		...
		clustersim psrelaytest psindextest psqueuetest psinteresttest psudptest
	./clustersim 500
	./slottest
	./psrelaytest
	./psindextest
