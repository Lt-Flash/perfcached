...
check-fast: selftest selftest_broken memprobe noisetest wipetest perfcached pubsubcli udppushcli \
		...
		clustersim psrelaytest psindextest psqueuetest psinteresttest psudptest rpsbench legmetatest
	./clustersim 500
	./slottest
	./legmetatest
	./psrelaytest
...
check: check-wired selftest selftest_broken memprobe noisetest wipetest perfcached perfcli perfdump perfload pcbench \
		...
		natbench slottest jwtest clustersim reachtest origintest indextest quiesctest regiontest legmetatest
	./clustersim 5000
	./reachtest
	./origintest
	./indextest
