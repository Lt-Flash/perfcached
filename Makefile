...
check-fast: selftest selftest_broken memprobe noisetest wipetest perfcached pubsubcli udppushcli \
		...
		clustersim psrelaytest psindextest psqueuetest psinteresttest psudptest rpsbench legmetatest legwalkremovetest histtest
	./clustersim 500
	./slottest
	./legmetatest
	./legwalkremovetest
...
check: check-wired selftest selftest_broken memprobe noisetest wipetest perfcached perfcli perfdump perfload pcbench \
		...
		natbench slottest jwtest clustersim reachtest origintest indextest quiesctest regiontest legmetatest legwalkremovetest histtest
	./clustersim 5000
	./reachtest
	./origintest
	./indextest
