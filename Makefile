...
perfcached: src/main.o src/config.o src/daemon.o src/proto.o src/json.o \
		...
		src/clpeers.o src/clpend.o src/clloc.o src/clboot.o src/clpush.o src/clwire.o src/clbulk.o src/clwork.o src/clmig.o src/clfwd.o src/clinit.o src/clres.o src/clmemb.o src/clpull.o src/clcol.o \
...
check-fast: selftest selftest_broken memprobe noisetest wipetest perfcached \
		...
		clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clpulltest clcoltest natbench slottest jwtest asyncbintest \
		clustersim
	./clustersim 500
	./slottest
	./jwtest
...
check: check-wired selftest selftest_broken memprobe noisetest wipetest perfcached perfcli perfdump perfload pcbench \
		libtest failovertest wedgetest asynctest asyncbintest clmaptest cltermtest clsynctest clhisttest clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clpulltest clcoltest \
...
clean:
	rm -f src/*.o src/compat/*.o src/core/*.o lib/*.o perfcached \
		...
		asynctest clmaptest cltermtest clsynctest clhisttest clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clrestest clmembtest clpulltest clcoltest
