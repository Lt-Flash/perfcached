...
check: check-wired selftest selftest_broken memprobe noisetest noiseboundtest wipetest perfcached perfcli perfdump perfload pcbench \
		...
		natbench slottest jwtest walringtest clustersim reachtest origintest indextest quiesctest regiontest legmetatest legwalkremovetest scanremovetest histtest capracetest arenadbgtest syncfailshim.so threadfreeze clapplytest evactest
	./clustersim 5000
	./clapplytest
	./evactest
	./reachtest
	...
	sh test/healtest.sh ./perfcached
