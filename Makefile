...
check: check-wired selftest selftest_broken memprobe noisetest wipetest perfcached perfcli pcbench \
...
clean:
	rm -f src/*.o src/compat/*.o src/core/*.o lib/*.o perfcached \
		perfcli libperfd.a libtest failovertest wedgetest selftest selftest_broken \
