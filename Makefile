...
perfcached: src/main.o src/config.o src/daemon.o src/proto.o src/json.o \
		...
		src/clpeers.o src/clpend.o src/clloc.o src/clboot.o src/clpush.o src/clwire.o src/clbulk.o src/clwork.o src/clmig.o src/clfwd.o src/clinit.o src/clres.o src/clmemb.o src/clpull.o src/clcol.o src/clplat.o src/clunk.o src/clsend.o src/clfleet.o src/clps.o src/clspread.o \
...
check-fast: selftest selftest_broken memprobe noisetest wipetest perfcached pubsubcli udppushcli \
		...
		clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clunktest clsendtest clfleettest clworktest clpstest clspreadtest clpulltest clcoltest clplattest natbench slottest jwtest asyncbintest \
		clustersim psrelaytest psindextest psqueuetest psinteresttest psudptest rpsbench legmetatest legwalkremovetest scanremovetest histtest
	./clustersim 500
	./slottest
	./legmetatest
	./legwalkremovetest
...
check: check-wired selftest selftest_broken memprobe noisetest wipetest perfcached perfcli perfdump perfload pcbench \
		libtest failovertest wedgetest asynctest asyncbintest clmaptest cltermtest clsynctest clhisttest clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clunktest clsendtest clfleettest clworktest clpstest clspreadtest clpulltest clcoltest clplattest \
		natbench slottest jwtest clustersim reachtest origintest indextest quiesctest regiontest legmetatest legwalkremovetest scanremovetest histtest
	./clustersim 5000
	./reachtest
	./origintest
	./indextest
