...
check-fast: selftest selftest_broken memprobe noisetest wipetest perfcached pubsubcli udppushcli \
		...
		clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clunktest clsendtest clfleettest clworktest clpstest clspreadtest clpulltest clcoltest clplattest natbench slottest jwtest asyncbintest routedpairtest \
		clustersim psrelaytest psindextest psqueuetest psinteresttest psudptest rpsbench legmetatest legwalkremovetest scanremovetest histtest capracetest
	./clustersim 500
	./slottest
	./legmetatest
	./legwalkremovetest
...
check: check-wired selftest selftest_broken memprobe noisetest wipetest perfcached perfcli perfdump perfload pcbench \
		libtest failovertest routedpairtest wedgetest asynctest asyncbintest clmaptest cltermtest clsynctest clhisttest clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clunktest clsendtest clfleettest clworktest clpstest clspreadtest clpulltest clcoltest clplattest \
		natbench slottest jwtest clustersim reachtest origintest indextest quiesctest regiontest legmetatest legwalkremovetest scanremovetest histtest capracetest
	./clustersim 5000
	./reachtest
	./origintest
	./indextest
...
clean:
	rm -f src/*.o src/compat/*.o src/core/*.o lib/*.o perfcached \
		perfcli perfdump perfload libperfd.a libtest failovertest routedpairtest capracetest wedgetest selftest selftest_broken \
