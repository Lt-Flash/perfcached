...
perfcached: src/main.o src/config.o src/daemon.o src/proto.o src/json.o \
		...
		src/clpeers.o src/clpend.o src/clloc.o src/clboot.o src/clpush.o src/clwire.o src/clbulk.o src/clwork.o src/clmig.o src/clfwd.o src/clinit.o src/clres.o src/clmemb.o src/clpull.o src/clcol.o src/clplat.o \
		src/obs.o src/metrics.o src/statuspage.o src/events.o src/quiesce.o src/pubsub.o $(CORE_OBJS) src/compat/compat.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
check-fast: selftest selftest_broken memprobe noisetest wipetest perfcached pubsubcli \
		perfcli pcbench clmaptest cltermtest clsynctest clhisttest \
		clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clpulltest clcoltest clplattest natbench slottest jwtest asyncbintest \
		clustersim
	./clustersim 500
	./slottest
	./jwtest
	sh test/readmetest.sh
	sh test/standalonetest.sh ./perfcached
...
check: check-wired selftest selftest_broken memprobe noisetest wipetest perfcached perfcli perfdump perfload pcbench \
		libtest failovertest wedgetest asynctest asyncbintest clmaptest cltermtest clsynctest clhisttest clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clmigtest clfwdtest clinittest clrestest clmembtest clpulltest clcoltest clplattest \
		natbench slottest jwtest clustersim reachtest origintest indextest quiesctest regiontest
	./clustersim 5000
	./reachtest
	./origintest
	./indextest
...
clean:
	rm -f src/*.o src/compat/*.o src/core/*.o lib/*.o perfcached \
		perfcli perfdump perfload libperfd.a libtest failovertest wedgetest selftest selftest_broken \
		memprobe noisetest pcbench routebench mmclient policybench concbench \
		asynctest clmaptest cltermtest clsynctest clhisttest clplacetest clseltest clpeerstest clpendtest clloctest clboottest clpushtest clwiretest clbulktest clrestest clmembtest clpulltest clcoltest clplattest
